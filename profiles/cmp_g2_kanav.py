"""cmp_g2_kanav — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp_g2_kanav --dry-run   # cost check, free
    python scraper.py --profile cmp_g2_kanav --yes
