"""cmp_lv_a_lovish — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp_lv_a_lovish --dry-run   # cost check, free
    python scraper.py --profile cmp_lv_a_lovish --yes
