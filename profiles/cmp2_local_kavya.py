"""cmp2_local_kavya — generated from a résumé by auto-apply/make_profile.py.

business analysis

    python scraper.py --profile cmp2_local_kavya --dry-run   # cost check, free
    python scraper.py --profile cmp2_local_kavya --yes
