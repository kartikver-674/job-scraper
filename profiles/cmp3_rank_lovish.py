"""cmp3_rank_lovish — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp3_rank_lovish --dry-run   # cost check, free
    python scraper.py --profile cmp3_rank_lovish --yes

HOW THE MODEL READ THIS RÉSUMÉ
local pipeline Also found 3 skill(s) written in the résumé and named by the market — lwc, rest, salesforce.
...
SCORING = {
    ...
    #   lwc                          its expansion 'lightning web components' is listed under skills
    #   rest                         named more than once
    #   salesforce                   listed under skills
    "skill_weights": {
        '.net worker services': 1,
        'android studio': 3,
        'apex': 4,
        'aura': 3,
        'batch apex': 5,
