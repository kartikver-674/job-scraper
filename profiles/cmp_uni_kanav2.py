"""cmp_uni_kanav2 — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp_uni_kanav2 --dry-run   # cost check, free
    python scraper.py --profile cmp_uni_kanav2 --yes
