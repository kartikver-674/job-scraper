"""cmp2_gemini_kanav_reactnative — generated from a résumé by auto-apply/make_profile.py.
...
React Native and cross-platform mobile engineer with 4+ years of experience building iOS and Android applications, optimizing performance, and utilizing Node.js/MongoDB backends.
    ...
    python scraper.py --profile cmp2_gemini_kanav_reactnative --dry-run   # cost check, free
    python scraper.py --profile cmp2_gemini_kanav_reactnative --yes
