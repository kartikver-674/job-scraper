"""cmp_gemini_lovish — generated from a résumé by auto-apply/make_profile.py.
...
Salesforce Engineer & Cross-Platform Flutter Developer with experience in Apex, LWC, SOQL, Batch processing, and mobile application development.
    ...
    python scraper.py --profile cmp_gemini_lovish --dry-run   # cost check, free
    python scraper.py --profile cmp_gemini_lovish --yes
