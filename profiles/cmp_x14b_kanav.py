"""cmp_x14b_kanav — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp_x14b_kanav --dry-run   # cost check, free
    python scraper.py --profile cmp_x14b_kanav --yes
