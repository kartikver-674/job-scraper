"""cmp_local_kanav_reactnative — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp_local_kanav_reactnative --dry-run   # cost check, free
    python scraper.py --profile cmp_local_kanav_reactnative --yes
