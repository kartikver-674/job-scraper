"""cmp2_local_kanav_reactnative — generated from a résumé by auto-apply/make_profile.py.

software engineering

    python scraper.py --profile cmp2_local_kanav_reactnative --dry-run   # cost check, free
    python scraper.py --profile cmp2_local_kanav_reactnative --yes

HOW THE MODEL READ THIS RÉSUMÉ
local pipeline Also found 11 skill(s) written in the résumé and named by the market — ai-assisted, android, authentication and 8 more.
...
SCORING = {
    ...
    #   ai-assisted                  listed under skills
    #   android                      named more than once
    #   authentication               listed under skills
    #   ci/cd                        listed under skills
    #   cross-platform               named more than once
    #   firebase                     listed under skills
    #   ios                          named more than once
    #   mobile architecture          named more than once
    #   modularization               named more than once
    #   offline-first                named more than once
    #   state management             named more than once
    "skill_weights": {
        'android studio': 3,
        'app center': 4,
        'c++': 2,
