"""cmp_localexp_kavya — generated from a résumé by auto-apply/make_profile.py.

business analysis

    python scraper.py --profile cmp_localexp_kavya --dry-run   # cost check, free
    python scraper.py --profile cmp_localexp_kavya --yes
...
SCORING = {
    "skill_weights": {
        ...
        'salesforce crm': 3,
        'salesforce functional consultant': 3,
